export const TranslationEN = {
  validationErrors: {
    ...
    IS_INCORRECT_LENGTH_PASSWORD:
      "Password must be from {{PASSWORD_MIN_LENGTH}} to {{PASSWORD_MAX_LENGTH}} symbols",
    ...
    IS_INCORRECT_LENGTH_USERNAME:
      "Username must be from {{USERNAME_MIN_LENGTH}} to {{USERNAME_MAX_LENGTH}} symbols",
    IS_INCORRECT_PHONE: "Phone number is not valid",
    IS_REQUIRED_TITLE: "Title is required",
    IS_INCORRECT_LENGTH_TITLE:
      "Title must be from {{TITLE_MIN_LENGTH}} to {{TITLE_MAX_LENGTH}} symbols;",

    IS_INCORRECT_LENGTH_DESCRIPTION:
      "Description must be less {{DESCRIPTION_MAX_LENGTH}} symbols;",
    IS_INCORRECT_LENGTH_SUMMARY:
      "Summary must be from {{SUMMARY_MIN_LENGTH}} to {{SUMMARY_MAX_LENGTH}} symbols",
    IS_INCORRECT_LENGTH_TASK_DESCRIPTION:
      "Description must be less {{TASK_DESCRIPTION_MAX_LENGTH}} symbols",
    IS_INCORRECT_LENGTH_KEYWORD:
      "Keyword must be more {{KEYWORD_MIN_LENGTH}} symbols",
    IS_INCORRECT_LENGTH_COLUMN:
      "Summary must be from {{COLUMN_MIN_LENGTH}} to {{COLUMN_MAX_LENGTH}} symbols",
    IS_INCORRECT_WORK_LOG_COMMENT:
      "Summary must be from {{WORK_LOG_COMMENT_MIN_LENGTH}} to {{WORK_LOG_COMMENT_MAX_LENGTH}} symbols",
